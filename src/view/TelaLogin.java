	...
	public TelaLogin() {
		...
		lblNewLabel_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				TelaCadChatContribuinte.getInstancia().setVisible(true);
			}
		});
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Contribuinte cprocurado = ControllerContribuinte.getInstancia()
						.getContribuinteByLogin(textField.getText());
				Funcionario fprocurado = ControllerFuncionario.getInstancia()
						.getFuncionarioByLogin(textField.getText());
				if (fprocurado != null && cprocurado == null) {
					JOptionPane.showMessageDialog(null, "Funcionario logado com sucesso!", "Sucesso",
							JOptionPane.INFORMATION_MESSAGE);
					TelaChatFuncionario.getInstancia().setFuncionariofuncionarioAtendente(fprocurado); // funcionario setado na janela de atendimento do chat para caso ele vai atender
					TelaMenuPrincipal.getInstancia().setVisible(true);
					setVisible(false);
				} else if (cprocurado != null && fprocurado == null) {
					// entrar no chat
					JOptionPane.showMessageDialog(null, "Contribuinte logado com sucesso!", "Sucesso",
							JOptionPane.INFORMATION_MESSAGE);
