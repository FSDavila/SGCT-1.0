...
public class TelaRelatorioPagamento extends JFrame {
	...
	private JRadioButton rdbtnCDA;
	private JRadioButton rdbtnPCDA;
...
//        System.out.println(ControllerPagamento.getInstancia().geraPagamentoParcela(21053440, 1, 823.15, cal.getTime()).getValorParcela());
//		
//        cal.set(Calendar.MONTH, 5);
//        System.out.println(ControllerPagamento.getInstancia().geraPagamentoParcela(21053440, 2, 823.15, cal.getTime()).getValorParcela());
//		
//        System.out.println(ControllerPagamento.getInstancia().geraPagamentoIntegral(111214, 6646.0, cal.getTime()));
//        
		...
		rdbtnPCDA = new JRadioButton("Parcela");
		rdbtnPCDA.setBounds(267, 68, 99, 23);
		contentPane.add(rdbtnPCDA);

		rdbtnCDA = new JRadioButton("CDA\r\n");
		...
		dateFim = new JDateChooser("dd/MM/yyyy", "##/##/#####", '_');
