					...
					public void actionPerformed(ActionEvent arg0) {
						...
						if (!nCDA.equals("") && !id.equals("")) {
							...
							CDA procurada = MapeadorCDA.getInstancia().get(Integer.parseInt(nCDA));
		                        ...
		                        JOptionPane.showMessageDialog(null, "Informe um numero de CDA Existente.", "Aviso", JOptionPane.WARNING_MESSAGE);
		                    }
							...
							if (cdas != null) {
		                        ...
		                        JOptionPane.showMessageDialog(null, "Informe um numero de CPF / CNPJ Valido.", "Aviso", JOptionPane.WARNING_MESSAGE);
		                    }
